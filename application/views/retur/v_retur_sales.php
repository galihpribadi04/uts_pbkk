...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form action="<?php echo base_url() . 'retur/add_to_retur' ?>" method="post" enctype="multipart/form-data" onsubmit="$('.preloader').show();">
                <table>
                    <tr>
                        <th>Retur Barang</th>
                    </tr>
            ...
            <div>
                <form action="<?php echo base_url() . 'retur/simpan_retur_pelanggan' ?>" method="post" enctype='multipart/form-data' onsubmit="$('.preloader').show();">
                    <div class="form-group">
                        <label for="pwd">Pelanggan:</label>
                        <select class="form-control" id="selectpelanggan" name="pelanggan"></select>
                    </div>
                    <div class="form-group">
                        <label for="pwd">Sales:</label>
                        <select class="form-control" id="selectsales" name="sales"></select>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table table-bordered table-condensed" id="barang">
                            <thead>
                                <tr>
        ...
        <script>
            $('#selectpelanggan').select2({
                ...
                allowClear: true,
                ajax: {
                    url: '<?php echo base_url('pelanggan/getsales') ?>',
                    dataType: 'json',
                    type: "GET",
                    delay: 250,
                    data: function(params) {
