...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="<?php echo base_url() . 'penjualan_grosir/add_to_cart' ?>" method="post"  onsubmit="$('.preloader').show();">
                <table>
                    <tr>
                        <th>Kode Barang</th>
                    </tr>
            ...
            <form action="<?php echo base_url() . 'penjualan_grosir/simpan_penjualan_grosir' ?>" method="post"  onsubmit="$('.preloader').show();">
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th style="text-align:right;">
                            <select class="form-control input-sm" style="text-align:right;margin-bottom:10px;" id="selectpelanggan" name="pembeli" required></select>
                    </tr>
                </table>
            </form>
            <hr />
