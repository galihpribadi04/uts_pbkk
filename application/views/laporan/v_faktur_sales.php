...
<div id="laporan">
	...
	<body onload="window.print()" style='font-family:tahoma; font-size:8pt;' class="A5">
		<center>
			<table style='width:580px; font-size:8pt; font-family:calibri; border-collapse: collapse;' border='0'>
				<?php 
	$b = $data->row_array();
	// die(print_r($b));
?>
...
?>
			...
			<table style='width:600; font-size:7pt;' cellspacing='2'>
				<tr>
					<td align='center'>Sales</br></br><br><br><u> (<?php echo ($b['user_nama']);?> )</u>
					</td>
					...
					<p>Jatuh Tempo Pembayaran : <b> <?php echo tgl_ind($b['jual_tanggal']);?></b></p>
